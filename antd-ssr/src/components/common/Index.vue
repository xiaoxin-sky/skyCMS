<template>
  <a-spin :spinning="spinning">
    <a-layout class="sky-layout" id="components-layout-demo-fixed">
      <a-layout-header class="header" >
        <div class="navbox">
          <router-link to="/index">
            <div class="logo">小新的个人博客网站</div>
          </router-link>
          <nav-bar></nav-bar>
        </div>
      </a-layout-header>
      <a-layout-content class="content">
        <a-row :gutter="16">
          ...
          <a-col :span="6"  class="gutter-box">
            <s-list-bar></s-list-bar>
          </a-col>
        </a-row>
      </a-layout-content>
      <a-layout-footer class="footer" >SkyCMS  Design ©2020 Created by 小新</a-layout-footer>
    </a-layout>
  </a-spin>
</template>
